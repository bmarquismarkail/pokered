...
.SECTION "Sound Effect Headers 1" FORCE BANK $02 SLOT 1 ORG $0000
.INCLUDE "audio/headers/sfxheaders1.asm"


.ENDS

.SECTION "Sound Effect Headers 2" FORCE BANK $08 SLOT 1 ORG $0000
.INCLUDE "audio/headers/sfxheaders2.asm"


.ENDS

.SECTION "Sound Effect Headers 3" FORCE BANK $1f SLOT 1 ORG $0000
...
.SECTION "Music Headers 1" FORCE BANK $02 SLOT 1 ORG $022e
.INCLUDE "audio/headers/musicheaders1.asm"


.ENDS

.SECTION "Music Headers 2" FORCE BANK $08 SLOT 1 ORG $02be
.INCLUDE "audio/headers/musicheaders2.asm"


.ENDS

.SECTION "Music Headers 3" FORCE BANK $1f SLOT 1 ORG $0249
...
.SECTION "Sound Effects 1" FORCE BANK $02 SLOT 1 ORG $02fd
...
Audio1_WavePointers:
.REDEFINE WAVE_POINTERS_LABEL "Audio1_WavePointers"
...
.SECTION "Sound Effects 2" FORCE BANK $08 SLOT 1 ORG $02fd
...
Audio2_WavePointers:
.REDEFINE WAVE_POINTERS_LABEL "Audio2_WavePointers"
.INCLUDE "audio/wave_samples.asm"
...
.SECTION "Sound Effects 3" FORCE BANK $1f SLOT 1 ORG $02fd
...
Audio3_WavePointers:
.REDEFINE WAVE_POINTERS_LABEL "Audio3_WavePointers"
.INCLUDE "audio/wave_samples.asm"
...
.SECTION "Audio Engine 1" FORCE BANK $02 SLOT 1 ORG $10c6
...
.SECTION "Low Health Alarm (Audio Engine 2)" FORCE BANK $08 SLOT 1 ORG $136e
...
.SECTION "Audio Engine 2" FORCE BANK $08 SLOT 1 ORG $1879
...
.SECTION "Audio Engine 3" FORCE BANK $1f SLOT 1 ORG $113b
...
.SECTION "Music 1" FORCE BANK $02 SLOT 1 ORG $1ba3
...
.SECTION "Music 2" FORCE BANK $08 SLOT 1 ORG $2322
...
.SECTION "Music 3" FORCE BANK $1f SLOT 1 ORG $1bbb
