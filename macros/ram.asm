...
; WLA-DX RAM sections require a label for every allocation. This preserves
; RGBDS's anonymous padding declarations while keeping their source intent.
.MACRO ram_skip
__wla_ram_padding_\@: ds \1
.ENDM
