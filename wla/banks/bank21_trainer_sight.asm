; Native WLA-DX form of engine/overworld/trainer_sight.asm.
.DEFINE SPRITESTATEDATA1_IMAGEINDEX 2
.DEFINE SPRITESTATEDATA1_YPIXELS 4
.DEFINE SPRITESTATEDATA1_XPIXELS 6
.DEFINE SPRITESTATEDATA1_FACINGDIRECTION 9
.DEFINE SPRITE_FACING_DOWN 0
.DEFINE SPRITE_FACING_UP 4
.DEFINE SPRITE_FACING_LEFT 8
.DEFINE SPRITE_FACING_RIGHT 12
.DEFINE NPC_MOVEMENT_UP $40
.DEFINE NPC_MOVEMENT_LEFT $80
.DEFINE NPC_MOVEMENT_RIGHT $c0
.DEFINE BIT_SEEN_BY_TRAINER 0
.DEFINE POWER_PLANT $53
.DEFINE CalcDifference $3633
.DEFINE MoveSprite_ $363d
.DEFINE EngageMapTrainer $336a
...
_SetSpritePosition1:
	...
	ldh (hSpriteIndex - $FF00), a
	call GetSpriteDataPointer
	ldh a, (hSpriteScreenYCoord - $FF00) ; x#SPRITESTATEDATA1_YPIXELS
	ld (HL+), a
	inc hl
	ldh a, (hSpriteScreenXCoord - $FF00) ; x#SPRITESTATEDATA1_XPIXELS
	ld (hl), a
	ld de, wSpritePlayerStateData2MapY - wSpritePlayerStateData1XPixels
	add hl, de
	ldh a, (hSpriteMapYCoord - $FF00) ; x#SPRITESTATEDATA2_MAPY
	ld (HL+), a
	ldh a, (hSpriteMapXCoord - $FF00) ; x#SPRITESTATEDATA2_MAPX
	ld (hl), a
	ret
...
_SetSpritePosition2:
	...
	ld (HL+), a ; x#SPRITESTATEDATA1_YPIXELS
	inc hl
