...
SilphCo8F_Object:
	...
	event_displacement SILPH_CO_8F_WIDTH, 16, 0

	event_displacement SILPH_CO_8F_WIDTH, 14, 0

	event_displacement SILPH_CO_8F_WIDTH, 18, 0

	event_displacement SILPH_CO_8F_WIDTH, 3, 11

	event_displacement SILPH_CO_8F_WIDTH, 3, 15

	event_displacement SILPH_CO_8F_WIDTH, 11, 5

	event_displacement SILPH_CO_8F_WIDTH, 11, 9