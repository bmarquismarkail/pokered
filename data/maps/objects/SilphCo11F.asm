...
SilphCo11F_Object:
	...
	event_displacement SILPH_CO_11F_WIDTH, 9, 0

	event_displacement SILPH_CO_11F_WIDTH, 13, 0

	event_displacement SILPH_CO_11F_WIDTH, 5, 5

	event_displacement SILPH_CO_11F_WIDTH, 3, 2