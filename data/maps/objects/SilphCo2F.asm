...
SilphCo2F_Object:
	...
	event_displacement SILPH_CO_2F_WIDTH, 24, 0

	event_displacement SILPH_CO_2F_WIDTH, 26, 0

	event_displacement SILPH_CO_2F_WIDTH, 20, 0

	event_displacement SILPH_CO_2F_WIDTH, 3, 3

	event_displacement SILPH_CO_2F_WIDTH, 13, 3

	event_displacement SILPH_CO_2F_WIDTH, 27, 15

	event_displacement SILPH_CO_2F_WIDTH, 9, 15