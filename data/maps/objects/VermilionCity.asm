...
VermilionCity_Object:
	...
	event_displacement VERMILION_CITY_WIDTH, 11, 3

	event_displacement VERMILION_CITY_WIDTH, 9, 13

	event_displacement VERMILION_CITY_WIDTH, 23, 13

	event_displacement VERMILION_CITY_WIDTH, 12, 19

	event_displacement VERMILION_CITY_WIDTH, 23, 19

	event_displacement VERMILION_CITY_WIDTH, 18, 31

	event_displacement VERMILION_CITY_WIDTH, 19, 31

	event_displacement VERMILION_CITY_WIDTH, 15, 13

	event_displacement VERMILION_CITY_WIDTH, 7, 3