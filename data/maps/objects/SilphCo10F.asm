...
SilphCo10F_Object:
	...
	event_displacement SILPH_CO_10F_WIDTH, 8, 0

	event_displacement SILPH_CO_10F_WIDTH, 10, 0

	event_displacement SILPH_CO_10F_WIDTH, 12, 0

	event_displacement SILPH_CO_10F_WIDTH, 9, 11

	event_displacement SILPH_CO_10F_WIDTH, 13, 15

	event_displacement SILPH_CO_10F_WIDTH, 13, 7