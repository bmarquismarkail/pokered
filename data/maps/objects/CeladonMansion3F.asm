...
CeladonMansion3F_Object:
	...
	event_displacement CELADON_MANSION_3F_WIDTH, 6, 1

	event_displacement CELADON_MANSION_3F_WIDTH, 7, 1

	event_displacement CELADON_MANSION_3F_WIDTH, 2, 1

	event_displacement CELADON_MANSION_3F_WIDTH, 4, 1