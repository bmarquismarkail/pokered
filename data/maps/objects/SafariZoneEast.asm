...
SafariZoneEast_Object:
	...
	event_displacement SAFARI_ZONE_EAST_WIDTH, 0, 4

	event_displacement SAFARI_ZONE_EAST_WIDTH, 0, 5

	event_displacement SAFARI_ZONE_EAST_WIDTH, 0, 22

	event_displacement SAFARI_ZONE_EAST_WIDTH, 0, 23

	event_displacement SAFARI_ZONE_EAST_WIDTH, 25, 9