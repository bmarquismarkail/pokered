...
Route15Gate1F_Object:
	...
	event_displacement ROUTE_15_GATE_1F_WIDTH, 0, 4

	event_displacement ROUTE_15_GATE_1F_WIDTH, 0, 5

	event_displacement ROUTE_15_GATE_1F_WIDTH, 7, 4

	event_displacement ROUTE_15_GATE_1F_WIDTH, 7, 5

	event_displacement ROUTE_15_GATE_1F_WIDTH, 6, 8