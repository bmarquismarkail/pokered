...
SeafoamIslands1F_Object:
	...
	event_displacement SEAFOAM_ISLANDS_1F_WIDTH, 4, 17

	event_displacement SEAFOAM_ISLANDS_1F_WIDTH, 5, 17

	event_displacement SEAFOAM_ISLANDS_1F_WIDTH, 26, 17

	event_displacement SEAFOAM_ISLANDS_1F_WIDTH, 27, 17

	event_displacement SEAFOAM_ISLANDS_1F_WIDTH, 7, 5

	event_displacement SEAFOAM_ISLANDS_1F_WIDTH, 25, 3

	event_displacement SEAFOAM_ISLANDS_1F_WIDTH, 23, 15
	; holes
