...
SafariZoneWest_Object:
	...
	event_displacement SAFARI_ZONE_WEST_WIDTH, 20, 0

	event_displacement SAFARI_ZONE_WEST_WIDTH, 21, 0

	event_displacement SAFARI_ZONE_WEST_WIDTH, 26, 0

	event_displacement SAFARI_ZONE_WEST_WIDTH, 27, 0

	event_displacement SAFARI_ZONE_WEST_WIDTH, 29, 22

	event_displacement SAFARI_ZONE_WEST_WIDTH, 29, 23

	event_displacement SAFARI_ZONE_WEST_WIDTH, 3, 3

	event_displacement SAFARI_ZONE_WEST_WIDTH, 11, 11