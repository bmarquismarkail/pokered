...
PokemonMansion2F_Object:
	...
	event_displacement POKEMON_MANSION_2F_WIDTH, 5, 10

	event_displacement POKEMON_MANSION_2F_WIDTH, 7, 10

	event_displacement POKEMON_MANSION_2F_WIDTH, 25, 14

	event_displacement POKEMON_MANSION_2F_WIDTH, 6, 1