...
RocketHideoutB1F_Object:
	...
	event_displacement ROCKET_HIDEOUT_B1F_WIDTH, 23, 2

	event_displacement ROCKET_HIDEOUT_B1F_WIDTH, 21, 2

	event_displacement ROCKET_HIDEOUT_B1F_WIDTH, 24, 19

	event_displacement ROCKET_HIDEOUT_B1F_WIDTH, 21, 24

	event_displacement ROCKET_HIDEOUT_B1F_WIDTH, 25, 19