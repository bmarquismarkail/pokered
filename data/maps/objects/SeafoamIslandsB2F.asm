...
SeafoamIslandsB2F_Object:
	...
	event_displacement SEAFOAM_ISLANDS_B2F_WIDTH, 5, 3

	event_displacement SEAFOAM_ISLANDS_B2F_WIDTH, 5, 13

	event_displacement SEAFOAM_ISLANDS_B2F_WIDTH, 13, 7

	event_displacement SEAFOAM_ISLANDS_B2F_WIDTH, 19, 15

	event_displacement SEAFOAM_ISLANDS_B2F_WIDTH, 25, 3

	event_displacement SEAFOAM_ISLANDS_B2F_WIDTH, 25, 11

	event_displacement SEAFOAM_ISLANDS_B2F_WIDTH, 25, 14