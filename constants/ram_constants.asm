...
.DEFINE BIT_NO_AUTO_TEXT_BOX 0

; wTextPredefFlag
.DEFINE BIT_TEXT_PREDEF 0
...
; wOptions
.DEFINE TEXT_DELAY_MASK %111
	const_def 6
	const BIT_BATTLE_SHIFT     ; 6
	const BIT_BATTLE_ANIMATION ; 7

.DEFINE TEXT_DELAY_FAST %001 ; 1
.DEFINE TEXT_DELAY_MEDIUM %011 ; 3
.DEFINE TEXT_DELAY_SLOW %101 ; 5
...
; wCurMapTileset
.DEFINE BIT_NO_PREVIOUS_MAP 7

; wCurrentBoxNum
.DEFINE BIT_HAS_CHANGED_BOXES 7
.DEFINE BOX_NUM_MASK %01111111
...
; rLCDC
.DEFINE LCDC_DEFAULT LCDC_ON | LCDC_WIN_9C00 | LCDC_WIN_ON | LCDC_BLOCK21 | LCDC_BG_9800 | LCDC_OBJ_8 | LCDC_OBJ_ON | LCDC_BG_ON
