SeafoamIslandsB2F_Script:
	...
	jr z, SeafoamIslandsB2F_Script.noBoulderWasPushed
	...
	ld a, [wCoordIndex]
	cp $1
	jr nz, SeafoamIslandsB2F_Script.boulder2FellDownHole
	...
	ld [wObjectToShow], a
	jr SeafoamIslandsB2F_Script.hideAndShowBoulderObjects
SeafoamIslandsB2F_Script.boulder2FellDownHole
	...
	ld [wObjectToShow], a
SeafoamIslandsB2F_Script.hideAndShowBoulderObjects
	ld a, [wObjectToHide]
...
SeafoamIslandsB2F_Script.noBoulderWasPushed
