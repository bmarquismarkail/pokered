...
UndergroundPathRoute7CopyUnusedGirlText:
	text_far WLA_GLOBAL_UndergroundPathRoute7CopyUnusedGirlText
	text_end

UndergroundPathRoute7CopyUnusedTeamRocketHadAHideoutText:
	text_far WLA_GLOBAL_UndergroundPathRoute7CopyUnusedTeamRocketHadAHideoutText
	text_end

UndergroundPathRoute7CopyUnusedMiddleAgedManText:
	text_far WLA_GLOBAL_UndergroundPathRoute7CopyUnusedMiddleAgedManText
	text_end

UndergroundPathRoute7CopyUnusedGoesUnderSaffronText:
	text_far WLA_GLOBAL_UndergroundPathRoute7CopyUnusedGoesUnderSaffronText
	text_end
