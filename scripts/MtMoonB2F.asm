MtMoonB2F_Script:
	...
	jr nc, MtMoonB2F_Script.enable_battles
	ld hl, wStatusFlags4
	set BIT_NO_BATTLES, [hl]
	ret
MtMoonB2F_Script.enable_battles
	ld hl, wStatusFlags4
...
MtMoonB2FMoveSuperNerdScript:
	...
	call ArePlayerCoordsInArray
	jr c, MtMoonB2FMoveSuperNerdScript.player_near_dome_fossil
	ld hl, MtMoonB2FPlayerNearHelixFossilCoords
	call ArePlayerCoordsInArray
	jp nc, CheckFightingMapTrainers
	ld de, MtMoon3FSuperNerdMoveUpMovementData
	jr MtMoonB2FMoveSuperNerdScript.continue
MtMoonB2FMoveSuperNerdScript.player_near_dome_fossil
	ld de, MtMoon3FSuperNerdMoveRightMovementData
MtMoonB2FMoveSuperNerdScript.continue
	ld a, MTMOONB2F_SUPER_NERD
	ldh [lobyte(hSpriteIndex)], a
	call MoveSprite
...
MtMoonB2FSuperNerdTakesOtherFossilScript:
	...
	jr z, MtMoonB2FSuperNerdTakesOtherFossilScript.got_dome_fossil
	ld a, TOGGLE_MT_MOON_B2F_FOSSIL_2
	jr MtMoonB2FSuperNerdTakesOtherFossilScript.continue
MtMoonB2FSuperNerdTakesOtherFossilScript.got_dome_fossil
	ld a, TOGGLE_MT_MOON_B2F_FOSSIL_1
MtMoonB2FSuperNerdTakesOtherFossilScript.continue
...
MtMoonB2FSuperNerdText:
	text_asm
	CheckEvent EVENT_BEAT_MT_MOON_EXIT_SUPER_NERD
	jr z, MtMoonB2FSuperNerdText.beat_super_nerd
	CheckEitherEventSet EVENT_GOT_DOME_FOSSIL, EVENT_GOT_HELIX_FOSSIL, 1
	jr nz, MtMoonB2FSuperNerdText.got_a_fossil
	ld hl, MtMoonB2fSuperNerdEachTakeOneText
	call PrintText
	jr MtMoonB2FSuperNerdText.done
MtMoonB2FSuperNerdText.beat_super_nerd
	...
	ld [wCurMapScript], a
	jr MtMoonB2FSuperNerdText.done
MtMoonB2FSuperNerdText.got_a_fossil
	ld hl, MtMoonB2FSuperNerdTheresAPokemonLabText
	call PrintText
MtMoonB2FSuperNerdText.done
	jp TextScriptEnd
...
MtMoonB2FDomeFossilText:
	...
	ld a, $1
	ld [wDoNotWaitForButtonPressAfterDisplayingText], a
	ld hl, MtMoonB2FDomeFossilText.YouWantText
	call PrintText
	call YesNoChoice
	ld a, [wCurrentMenuItem]
	and a
	jr nz, MtMoonB2FDomeFossilText.done
	lb "bc", DOME_FOSSIL, 1
	call GiveItem
	...
	ld [wMtMoonB2FCurScript], a
	ld [wCurMapScript], a
MtMoonB2FDomeFossilText.done
	jp TextScriptEnd

MtMoonB2FDomeFossilText.YouWantText:
	text_far WLA_GLOBAL_MtMoonB2FDomeFossilYouWantText
	text_end
...
MtMoonB2FHelixFossilText:
	...
	ld a, $1
	ld [wDoNotWaitForButtonPressAfterDisplayingText], a
	ld hl, MtMoonB2FHelixFossilText.YouWantText
	call PrintText
	call YesNoChoice
	ld a, [wCurrentMenuItem]
	and a
	jr nz, MtMoonB2FHelixFossilText.done
	...
	ld [wMtMoonB2FCurScript], a
	ld [wCurMapScript], a
MtMoonB2FHelixFossilText.done
	jp TextScriptEnd

MtMoonB2FHelixFossilText.YouWantText:
	text_far WLA_GLOBAL_MtMoonB2FHelixFossilYouWantText
	text_end
...
MtMoonB2FReceivedFossilText.Text:
	text_far WLA_GLOBAL_MtMoonB2FReceivedFossilText
	sound_get_key_item
	text_waitbutton
	text_end

MtMoonB2FYouHaveNoRoomText:
	ld hl, MtMoonB2FYouHaveNoRoomText.Text
	call PrintText
	jp TextScriptEnd

MtMoonB2FYouHaveNoRoomText.Text:
	text_far WLA_GLOBAL_MtMoonB2FYouHaveNoRoomText
	text_waitbutton
	text_end

MtMoonB2FSuperNerdTheyreBothMineText:
	text_far WLA_GLOBAL_MtMoonB2FSuperNerdTheyreBothMineText
	text_end

MtMoonB2FSuperNerdOkIllShareText:
	text_far WLA_GLOBAL_MtMoonB2FSuperNerdOkIllShareText
	text_end

MtMoonB2fSuperNerdEachTakeOneText:
	text_far WLA_GLOBAL_MtMoonB2fSuperNerdEachTakeOneText
	text_end

MtMoonB2FSuperNerdTheresAPokemonLabText:
	text_far WLA_GLOBAL_MtMoonB2FSuperNerdTheresAPokemonLabText
	text_end

MtMoonB2FSuperNerdThenThisIsMineText:
	text_far WLA_GLOBAL_MtMoonB2FSuperNerdThenThisIsMineText
	sound_get_key_item
	text_end

MtMoonB2FRocket1BattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket1BattleText
	text_end

MtMoonB2FRocket1EndBattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket1EndBattleText
	text_end

MtMoonB2FRocket1AfterBattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket1AfterBattleText
	text_end

MtMoonB2FRocket2BattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket2BattleText
	text_end

MtMoonB2FRocket2EndBattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket2EndBattleText
	text_end

MtMoonB2FRocket2AfterBattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket2AfterBattleText
	text_end

MtMoonB2FRocket3BattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket3BattleText
	text_end

MtMoonB2FRocket3EndBattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket3EndBattleText
	text_end

MtMoonB2FRocket3AfterBattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket3AfterBattleText
	text_end

MtMoonB2FRocket4BattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket4BattleText
	text_end

MtMoonB2FRocket4EndBattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket4EndBattleText
	text_end

MtMoonB2FRocket4AfterBattleText:
	text_far WLA_GLOBAL_MtMoonB2FRocket4AfterBattleText
	text_end
