...
Route20BoulderScript:
	...
	jr z, Route20BoulderScript.next_boulder_check
	ld a, TOGGLE_SEAFOAM_ISLANDS_1F_BOULDER_1
	call Route20ShowObjectScript
	ld a, TOGGLE_SEAFOAM_ISLANDS_1F_BOULDER_2
	call Route20ShowObjectScript
	ld hl, Route20BoulderScript.ToggleableObjectIDs
Route20BoulderScript.hide_toggleable_objects
	ld a, [hli]
	cp $ff
	jr z, Route20BoulderScript.next_boulder_check
	push hl
	...
	pop hl
	jr Route20BoulderScript.hide_toggleable_objects

Route20BoulderScript.ToggleableObjectIDs:
...
Route20BoulderScript.next_boulder_check
...
Route20Swimmer1BattleText:
	text_far WLA_GLOBAL_Route20Swimmer1BattleText
	text_end

Route20Swimmer1EndBattleText:
	text_far WLA_GLOBAL_Route20Swimmer1EndBattleText
	text_end

Route20Swimmer1AfterBattleText:
	text_far WLA_GLOBAL_Route20Swimmer1AfterBattleText
	text_end

Route20Swimmer2BattleText:
	text_far WLA_GLOBAL_Route20Swimmer2BattleText
	text_end

Route20Swimmer2EndBattleText:
	text_far WLA_GLOBAL_Route20Swimmer2EndBattleText
	text_end

Route20Swimmer2AfterBattleText:
	text_far WLA_GLOBAL_Route20Swimmer2AfterBattleText
	text_end

Route20Swimmer3BattleText:
	text_far WLA_GLOBAL_Route20Swimmer3BattleText
	text_end

Route20Swimmer3EndBattleText:
	text_far WLA_GLOBAL_Route20Swimmer3EndBattleText
	text_end

Route20Swimmer3AfterBattleText:
	text_far WLA_GLOBAL_Route20Swimmer3AfterBattleText
	text_end

Route20Swimmer4BattleText:
	text_far WLA_GLOBAL_Route20Swimmer4BattleText
	text_end

Route20Swimmer4EndBattleText:
	text_far WLA_GLOBAL_Route20Swimmer4EndBattleText
	text_end

Route20Swimmer4AfterBattleText:
	text_far WLA_GLOBAL_Route20Swimmer4AfterBattleText
	text_end

Route20Swimmer5BattleText:
	text_far WLA_GLOBAL_Route20Swimmer5BattleText
	text_end

Route20Swimmer5EndBattleText:
	text_far WLA_GLOBAL_Route20Swimmer5EndBattleText
	text_end

Route20Swimmer5AfterBattleText:
	text_far WLA_GLOBAL_Route20Swimmer5AfterBattleText
	text_end

Route20Swimmer6BattleText:
	text_far WLA_GLOBAL_Route20Swimmer6BattleText
	text_end

Route20Swimmer6EndBattleText:
	text_far WLA_GLOBAL_Route20Swimmer6EndBattleText
	text_end

Route20Swimmer6AfterBattleText:
	text_far WLA_GLOBAL_Route20Swimmer6AfterBattleText
	text_end

Route20CooltrainerMBattleText:
	text_far WLA_GLOBAL_Route20CooltrainerMBattleText
	text_end

Route20CooltrainerMEndBattleText:
	text_far WLA_GLOBAL_Route20CooltrainerMEndBattleText
	text_end

Route20CooltrainerMAfterBattleText:
	text_far WLA_GLOBAL_Route20CooltrainerMAfterBattleText
	text_end

Route20Swimmer7BattleText:
	text_far WLA_GLOBAL_Route20Swimmer7BattleText
	text_end

Route20Swimmer7EndBattleText:
	text_far WLA_GLOBAL_Route20Swimmer7EndBattleText
	text_end

Route20Swimmer7AfterBattleText:
	text_far WLA_GLOBAL_Route20Swimmer7AfterBattleText
	text_end

Route20Swimmer8BattleText:
	text_far WLA_GLOBAL_Route20Swimmer8BattleText
	text_end

Route20Swimmer8EndBattleText:
	text_far WLA_GLOBAL_Route20Swimmer8EndBattleText
	text_end

Route20Swimmer8AfterBattleText:
	text_far WLA_GLOBAL_Route20Swimmer8AfterBattleText
	text_end

Route20Swimmer9BattleText:
	text_far WLA_GLOBAL_Route20Swimmer9BattleText
	text_end

Route20Swimmer9EndBattleText:
	text_far WLA_GLOBAL_Route20Swimmer9EndBattleText
	text_end

Route20Swimmer9AfterBattleText:
	text_far WLA_GLOBAL_Route20Swimmer9AfterBattleText
	text_end

Route20SeafoamIslandsSignText:
	text_far WLA_GLOBAL_Route20SeafoamIslandsSignText
	text_end
