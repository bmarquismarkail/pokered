...
Route8GateDefaultScript:
	...
	ret nz
	ld hl, Route8GateDefaultScript.PlayerInCoordsArray
	...
	and a
	jr nz, Route8GateDefaultScript.have_drink
	...
	ret
Route8GateDefaultScript.have_drink
	ld hl, wStatusFlags1
...
Route8GateDefaultScript.PlayerInCoordsArray:
	dbmapcoord  2,  3
	dbmapcoord  2,  4
	.DB -1 ; end
