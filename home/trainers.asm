...
ExecuteCurMapScriptInTable:
	...
	jr z, ExecuteCurMapScriptInTable.useProvidedIndex
	ld a, [wCurMapScript]
...
ReadTrainerHeaderInfo.nonZeroOffset
	...
	jr z, ReadTrainerHeaderInfo.readPointer
...
TalkToTrainer:
	...
	ld a, c
	and a
	jr z, TalkToTrainer.trainerNotYetFought
...
EndTrainerBattle:
	...
	cp OPP_ID_OFFSET
	jr nc, EndTrainerBattle.skipRemoveSprite
